...
namespace El_Projekte_Grande.Models
{
    ...
    public class ProductRepository : IProductRepository
    {
        ...
        public IEnumerable<Product> GetAllProduct => new List<Product>
        {
            ...
            new Product{ProductId =4,Name="Diament",Price =6.99M,Description="Lorem ipsum dolor sit amet .", Category = _categoryRepository.GetAllCategories.ToList()[3],IsInStock = true,IsOnSale = true},
